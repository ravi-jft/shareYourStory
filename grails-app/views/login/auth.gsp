    ...
    <div class='inner'>
        ...
        <form action='${postUrl}' method='POST' id='loginForm' class='cssform' autocomplete='off'>
            <p>
                ...
                <input type='text' class='text_' name='j_username' id='username' placeholder="my enter username or emailid"/>
            </p>

            <p>
                <label for='password'><g:message code="springSecurity.login.password.label"/>:</label>
                <input type='password' class='text_' name='j_password' id='password' placeholder="enter password" />
            </p>
